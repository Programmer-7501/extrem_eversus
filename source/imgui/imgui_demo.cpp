...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Selection MobileSuitState: Single Selection"))
        {
        ...
        if (ImGui::TreeNode("Selection MobileSuitState: Multiple Selection"))
        {
    ...
    if (ImGui::TreeNode("Querying Status (Edited/Active/Focused/Hovered etc.)"))
    {
        ...
        ImGui::Combo("Item ActorType", &item_type, item_names, IM_ARRAYSIZE(item_names), IM_ARRAYSIZE(item_names));
        ImGui::SameLine();
        ...
        ImGui::Checkbox("Hovered/Active tests after InputBegin() for title bar testing", &test_window);
        if (test_window)
        {
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        HelpMarker(
            ...
            "You may want to also explicitly specify content width by using SetNextWindowContentWidth() before InputBegin().");
        static int lines = 7;
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Tree view"))
    {
        ...
        if (ImGui::BeginTable("3ways", 3, flags))
        {
            ...
            ImGui::TableSetupColumn("ActorType", ImGuiTableColumnFlags_WidthFixed, TEXT_BASE_WIDTH * 18.0f);
            ImGui::TableHeadersRow();
...
static void ShowDemoWindowMisc()
{
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        // Display Mouse state
        if (ImGui::TreeNode("Mouse MobileSuitState"))
        {
        ...
        if (ImGui::TreeNode("Keyboard & Navigation MobileSuitState"))
        {
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple overlay", p_open, window_flags))
    {
        ...
        ImGui::Separator();
        if (ImGui::IsMousePosValid())
            ImGui::Text("Mouse CameraPosition: (%.1f,%.1f)", io.MousePos.x, io.MousePos.y);
        else
            ImGui::Text("Mouse CameraPosition: <invalid>");
        if (ImGui::BeginPopupContextWindow())
        {
