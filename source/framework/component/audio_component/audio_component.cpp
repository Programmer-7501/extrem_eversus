...
IXAudio2*				AudioComponent::m_Xaudio = NULL;
IXAudio2MasteringVoice*	AudioComponent::m_MasteringVoice = NULL;
...
void AudioComponent::InitMaster()
{
	// COM初期化
...
void AudioComponent::UninitMaster()
{
